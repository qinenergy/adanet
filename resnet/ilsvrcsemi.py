...
class ILSVRC12Files(RNGDataFlow):
    ...
    def __init__(self, dir, name, meta_dir=None,
                 shuffle=None, dir_structure=None, labeled=True):
        """
        ...
        self.imglist = meta.get_image_list(name, dir_structure, labeled=labeled)
...
class ILSVRC12(ILSVRC12Files):
    ...
    def __init__(self, dir, name, meta_dir=None,
        ...
        super(ILSVRC12, self).__init__(
            dir, name, meta_dir, shuffle, dir_structure, labeled=labeled)
    """
